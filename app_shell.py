...
from utils.settings import maintenance_enabled, contact_email
from pages.home import page_home
from pages.checkout import page_checkout
from pages.track_order import page_track_order
...
def _maintenance_overlay():
    ...
    st.markdown('<div class="maintenance-sub">Please try again later. If you need help, email <b>{}</b>.</div>'.format(contact_email()), unsafe_allow_html=True)
...
def run_app():
    ...
    # Maintenance gate (customer side only)
